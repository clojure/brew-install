...
cp target/classes/clojure/install/clojure target/classes/clojure/install/clj target/classes/clojure/install/deps.edn target/classes/clojure/install/example-deps.edn target/classes/clojure/install/install.sh "target/clojure-tools-$version.jar" doc/clojure.1 target/clojure-tools
