...
cp target/classes/clojure target/classes/clj target/classes/clj_exec.clj target/classes/deps.edn target/classes/example-deps.edn target/classes/install.sh "target/clojure-tools-$version.jar" doc/clojure.1 target/clojure-tools
...
cp target/classes/ClojureTools.psd1 target/classes/ClojureTools.psm1 target/classes/clj_exec.clj target/classes/deps.edn target/classes/example-deps.edn "target/clojure-tools-$version.jar" target/win/ClojureTools
cd target/win
